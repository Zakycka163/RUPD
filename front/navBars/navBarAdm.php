<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        ...
        <a class="dropdown-item" href="/pages/404.php" hidden>Список УМП</a>
			<div class="dropdown-divider" hidden></div>
		<a class="dropdown-item" href="/pages/404.php" hidden>Заполнить договор</a>
			<div class="dropdown-divider" hidden></div>
		<h6 class="dropdown-header text-primary" hidden>Лабораторный практикум</h6>
		<a class="dropdown-item" href="/pages/404.php" hidden>Создать ЛП</a>
        <a class="dropdown-item" href="/pages/404.php" hidden>Список ЛП</a>
			<div class="dropdown-divider" hidden></div>
		<h6 class="dropdown-header text-primary" hidden>Практическая работа</h6>
		<a class="dropdown-item" href="/pages/404.php" hidden>Создать ПР</a>
        <a class="dropdown-item" href="/pages/404.php" hidden>Список ПР</a>
    </div>
</li>
<li class="nav-item">
