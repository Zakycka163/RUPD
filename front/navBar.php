        ...
        <ul class="nav nav-pills">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item btn btn-link btn-sm" href="/pages/control/users.php?id=<?php echo($id);?>"
                        title="<?php print(''.$first.' '.$second.'')?>">
                        Мой аккаунт
                    </a>
                    <?php if($admin=="2"){ ?>
                    <a class="dropdown-item btn btn-sm d-md-none" href="/pages/control/users.php?action=create">Новый
                        аккаунт</a>
...
<div class="pos-f-t sticky-top d-sm-none">
    <nav class="navbar bg-light sticky-top">
        ...
        <?php if(!empty($_SESSION["id"])){ ?>
        <form class="form-inline">
            <input class="btn btn-danger btn-sm" onclick="location.href='/pages/sign_in.php'" type="button"
                value="Выход">
        </form>
        <?php } else { ?>
        <form class="form-inline">
            <input class="btn btn-success btn-sm" onclick="location.href='/pages/sign_in.php'" type="button"
                value="Войти">
        </form>
        <?php } ?>
    </nav>
